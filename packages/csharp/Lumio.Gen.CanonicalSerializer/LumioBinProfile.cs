...
public readonly record struct LumioBinGolden(string Id, string Case, string Sha256);
...
public readonly record struct LumioBinRejection(string Id, string Case, string Error);
