---
name: 2026-09-01-rm-00011-phase0-contracts
description: RM-00011 Phase 0 的 Wave 0 契约冻结进度报告;核该阶段交付与证据时查
metadata:
  type: doc
  status: 实施中
---
...
Wave 0 C-1…C-4 are merged on `rm00011/merge-wave0` with ADR index + `docs/adr` mode `120000` symlinks（该兼容目录此后随文档治理收敛删除） + `engine/wire/README.md` rows. Owner wire landing is `2026-09-01-owner-wire-landing.md`. Hello-wire-v1 is not extended. Old Schema/ID/Fixture/Baseline/seven-repo-mirror toolchain is not restored.
