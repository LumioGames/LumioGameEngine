...
- 本仓是 LumioGameEngine V3 架构、状态机、公共契约、依赖图和变更规则的唯一来源；当前基线为 `LGE-V1.0-2026-08-27`。
- 规范正文是 [`LumioGameEngine_Architecture_v1.0.md`](../../../docs/architecture/LumioGameEngine_Architecture_v1.0.md)，公共决策唯一入口是 [`.spec/decisions/`](../../decisions/README.md)。
