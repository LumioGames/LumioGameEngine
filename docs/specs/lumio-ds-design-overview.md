...
> 怎么吵出来的、每一板的理由、和外部调研的对账，全在[裁决流水](2026-08-29-ds-server-architecture-decisions.md)与[接缝裁决流水](2026-09-01-seam-closure-decisions.md)里，本文不背这些包袱——本文只回答五个问题：**这是什么、长什么样、每块干什么、按什么顺序做、什么不许做。**
> 配套：[ECS 设计概要](lumio-ecs-design-overview.md)（视野表、变更集、实体绑定的真值方）、[存档设计概要](lumio-save-design-overview.md)、[GAS 设计概要](lumio-gas-design-overview.md)。
